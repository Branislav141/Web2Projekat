...
export class IncidentService {
  ...
  mockedIncidents(): Array<Incident> {
    ...
    const c1 = new Incident(200, 'aaa', 'bbb', 'ccc', 'ddd');
    const c2 = new Incident(200, 'pera', 'zika', 'laza', 'ddd');
    const c3 = new Incident(200, 'pera', 'zika', 'laza', 'ddd');
    const c4 = new Incident(200, 'pera', 'zika', 'laza', 'ddd');
    const c5 = new Incident(200, 'pera', 'zika', 'laza', 'ddd');
    const c6 = new Incident(500, 'pera', 'zika', 'laza', 'ddd');
    const c7 = new Incident(400, 'pera', 'zika', 'laza', 'ddd');
